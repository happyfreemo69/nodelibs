...
exports.setItemLinks = function(x, preUrl){
    Object.keys(x).forEach(function(key){
        if(typeof(x[key]=='object') && x[key] != null && x[key].links){
...
exports.fastTransform = function(req, mainObj){
    var preUrl = (req.headers && req.headers.linkprotocol || req.protocol)+ '://'+ req.get('host')+ "/v1";
    if(mainObj.items){
...
exports.transform = function(req, mainObj){
    ...
    function transformObj(req, obj){
        ...
        if(typeof(obj)=='string'){
            ...
            return [(req.headers && req.headers.linkprotocol || req.protocol), '://', req.get('host'), "/v1", obj.substring(tok+2)].join('');
        }
