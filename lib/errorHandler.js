...
function fwdError(str, done){
    ...
    try{
        ...
        error = new RfError({statusCode:500, message: str, details:'assetD rejection'});
    }
    if(typeof(done)=='function'){
        return done(error);
    }
...
exports.confRf = function(RF, config, cbks){
    ...
    var rfOptions = {
        ...
        onError:function(e){
            ...
            if(!e.message || e.message && e.message.indexOf('INVALID_PARAMETERS')!=-1){
