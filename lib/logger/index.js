 ...
 * }
 * @param { boolean } [disableWinston] [tells whether winston online reporting is enabled or not]
 *
 ...
 */
function Logger(options, config, disableWinston){
    ...
    this.disableWinston = disableWinston;
}
