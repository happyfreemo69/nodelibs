...
function LogProc(opts){
    ...
    this.opts.minBlockLength = opts.minBlockLength || 1e3;         //1ko or more should be logged
    this.opts.minFullLength = opts.minFullLength   || 1e6;           //two many kos should empty the stack. Check the endpoint for its bitrate
