...
dic.geoD = {
    pub:{
        ...
        dev: 'https://geod-dev.citylity.com',
        uat: 'https://geod-tst.citylity.com',
        ppt: 'https://geod-prd.citylity.com',
        prd: 'https://geod-prd.citylity.com'
    },
    pri:{
        usr: 'http://geod-tst.citylity.com:80',
        dev: 'http://geod-dev.citylity.com:80',
        uat: 'http://geod-tst.citylity.com:80',
        ppt: 'http://geod-prd.citylity.com:80',
        prd: 'http://geod-prd.citylity.com:80'
    }
};
...
dic.lgs = {
    ...
    pri:{
        ...
        dev: 'http://lgs-dev.citylity.com:4012',
...
dic.gateway = {
    pub:{
        usr: 'https://gateway-usr.citylity.com',
        dev: 'https://gateway-dev.citylity.com',
        uat: 'https://gateway-uat.citylity.com',
        ppt: 'https://gateway-ppt.citylity.com',
        prd: 'https://gateway.citylity.com'
    },
    pri:{
        usr: 'http://gateway-usr.citylity.com:80',
        dev: 'http://gateway-dev.citylity.com:80',
        uat: 'http://gateway-uat.citylity.com:80',
        ppt: 'http://gateway-ppt.citylity.com:80',
        prd: 'http://gateway.citylity.com:80'
    }
};

dic.admserv = {
    pub:{
        usr: 'https://admserv-usr.citylity.com',
        dev: 'https://admserv-dev.citylity.com',
        uat: 'https://admserv-uat.citylity.com',
        ppt: 'https://admserv-ppt.citylity.com',
        prd: 'https://admserv.citylity.com'
    },
    pri:{
        usr: 'https://admserv-usr.citylity.com',
        dev: 'https://admserv-dev.citylity.com',
