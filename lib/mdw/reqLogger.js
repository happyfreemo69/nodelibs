...
module.exports = function(config){
    var onStart = function(req, res, next){
        ...
        if(req.headers && req.headers.os){
            osHeader = req.headers.os.substring(0,10);
        }

        config.logger.inf('REQUEST', req.method, osHeader ,req.url, JSON.stringify(req.body), getip(req));
    ...
    return function(req, res, next){
        ...
        res.send = function(){
            ...
            config.logger.sta('REQURL', req.method, osHeader, req.url, elapsed, 'ms');
